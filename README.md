...
- ***Waveform Checks*** - 
  ...
  -  Check for modes which are noise dominant
  -  Check for initial frequency
  -  Check compatibility with waveform pipelines (Lalsim, PyCBC)
  -  Check matches - comparison with other approximants
