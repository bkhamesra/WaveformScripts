...
def create_single_h5 (dirpath, movepath_h5, movepath_wf, verbose=False):			 #dirpath - path to directory which contains the strain data of the waveform
    ...
    if verbose: print("*(Create_single_h5) >> Frequency of (2,2) mode after junk radiation -  Momega = {} \n".format(Mf_initial))
...
failed_path = "/numrel/NumRel/bkhamesra3/Finalized_Waveforms/Waveform_files/Failed/AlignedSpin"
wf_direc = "/numrel/NumRel/bkhamesra3/Finalized_Waveforms/Waveform_files/Remaining/AlignedSpin"
