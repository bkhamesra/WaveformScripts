#................................................................................................
# Use: Script to generate waveform from compact binary simulations and store in HdF5 format for LAL injection. 
# This scripts collects the strain data generated from matlab, performs mean centering, cleaning, metadata generation and data compression using romspline package (provided).
# Dependencies - numpy, matplotlib, glob, os, shutil, romspline 
# Reference: Script is designed based on the information described in  "Numerical Relativity Injection infrastructure":https://arxiv.org/pdf/1703.01076.pdf
...
def crop_data(dirpath, time, hp, hx):
    '''Remove the junk radiation part of the waveform''' 
...
def create_plot(varx, vary, label_x, label_y, figpath, figname):
    '''Generate line plot of x vs y, save file figname in figpath''' 
...
h5output_path = "/localdata2/bkhamesra3/Waveforms/H5Files" 
wfoutput_path = "/localdata2/bkhamesra3/Waveforms/Completed" 
failed_path = "/localdata2/bkhamesra3/Waveforms/Failed/Precessing"
wf_direc = "/localdata2/bkhamesra3/Waveforms/Remaining/Precessing"

if not os.path.exists(failed_path): os.makedirs(failed_path)
if not os.path.exists(wfoutput_path): os.makedirs(wfoutput_path)

#Uncomment this line if only single waveform
