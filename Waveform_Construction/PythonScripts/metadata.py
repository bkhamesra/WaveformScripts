...
# Use - This script generates the metadata from simulation as specfied in arXiv:1703.01076. This is required to 
# create the waevform in LIGO compatible formats. 
#-----------------------------------------------------------------------
...
def metadata(dirpath, jkrad_time, Error_Series = False, verbose=False):
        '''Compute the metadata for the simulation
        
        Parameters - 
        dirpath (str) - simulation output path generated by Matlab scripts
        jkrad_time (float) - junk radiation time
        Error_Series (float) - Provide additional error series if available
        verbose(boolean) - Set to true to get more detailed output - Useful for debugging
        '''
